"""
In the 20×20 grid below, four numbers along a diagonal line are 26, 63, 78, 14.
...
"""
from data.tools.tools import product_of_seq
...
DIGITS = 4
print(find_max_in_grid(GRID, DIGITS))
